...
export default function Features() {
    ...
    return (
        <Container className="container-fluid">
            ...
            <Row>
                <Col xs={12} sm={4} className="d-flex align-items-center flex-column" data-aos="fade-right">
                ...
                <Col xs={12} sm={4} className="d-flex align-items-center flex-column" data-aos="fade-right" data-aos-delay="300">
                ...
                <Col xs={12} sm={4} className="d-flex align-items-center flex-column" data-aos="fade-right" data-aos-delay="600">
